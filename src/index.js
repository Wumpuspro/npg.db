...
// Require Database
    ...
    module = {
         ...
         * console.log(require('npg.db').version);
         */
        ...
        fetch: function (key, ops) {
            if (!key)
                throw new TypeError(
                    "No key specified. Need Help? Check Out: discord.gg/npg"
                );
        ...
        set: function (key, value, ops) {
            ...
            if (value === undefined)
                throw new TypeError(
                    "No value specified. Need Help? Check Out: discord.gg/npg"
                );
        ...
        add: function (key, value, ops) {
            ...
            if (isNaN(value))
                throw new TypeError(
                    "Must specify value to add. Need Help? Check Out: discord.gg/npg"
                );
        ...
        push: function (key, value, ops) {
            ...
            if (!value && value != 0)
                throw new TypeError(
                    "Must specify value to push. Need Help? Check Out: discord.gg/npg"
                );
     ...
     */
        ...
        table: function (tableName, options = {}) {
            ...
            if (typeof tableName !== "string")
                throw new TypeError(
                    "Table name has to be a string. Need Help? Check out: discord.gg/npg"
                );
            else if (tableName.includes(" "))
                throw new TypeError(
                    "Table name cannot include spaces. Need Help? Check out: discord.gg/npg"
                );
